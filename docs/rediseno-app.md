...
10. **Swing.** El script lo lee y lo loguea pero **nunca lo incluye en el payload** a HA. ¿Se maneja por otro camino, quedó sin implementar, o los aires actuales no usan swing? ¿La nueva app debe mandarlo (y en ese caso: en la clave de la planilla o como comando aparte)? (Absorbe la vieja pregunta 3 de swing/sleep.)
