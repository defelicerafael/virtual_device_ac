...
class CommandSender {
  ...
  /**
   * Learning de swing (def. 5 v3 + 7): manda a ac_learn la clave a aprender
   * ('on'/'off' o una posición). ⚠️ Contrato nuevo con el servidor (el
   * script de ac_learn debe soportar `swing`).
   */
